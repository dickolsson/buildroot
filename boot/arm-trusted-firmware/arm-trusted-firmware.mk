...
ifeq ($(BR2_TARGET_ARM_TRUSTED_FIRMWARE_TBB),y)
ARM_TRUSTED_FIRMWARE_DEPENDENCIES += host-mbedtls
ARM_TRUSTED_FIRMWARE_MAKE_OPTS += \
	MBEDTLS_DIR=$(HOST_DIR)/share/mbedtls/ \
	TRUSTED_BOARD_BOOT=1 \
	GENERATE_COT=1

ifneq ($(call qstrip,$(BR2_TARGET_ARM_TRUSTED_FIRMWARE_TBB_ROT)),)
ARM_TRUSTED_FIRMWARE_MAKE_OPTS += \
	ARM_ROTPK_LOCATION=devel_rsa \
	ROT_KEY=$(call qstrip,$(BR2_TARGET_ARM_TRUSTED_FIRMWARE_TBB_ROT))
endif
endif
